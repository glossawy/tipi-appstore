...
## Default: false
disable_confirm_dialog = ${KOMODO_DISABLE_CONFIRM_DIALOG}
...
## Default: false
disable_user_registration = ${APP_KOMODO_DISABLE_USER_REGISTRATION}
...
jwt_secret = "${APP_KOMODO_JWT_SECRET}"
...
## Optional, no default.
webhook_secret = "${APP_KOMODO_WEBHOOK_SECRET}"
